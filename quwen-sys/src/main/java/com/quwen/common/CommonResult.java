...
public class CommonResult extends BaseResult {
    ...
    public CommonResult(int msgCode, String errMsg, ZonedDateTime receiptDateTime, ZonedDateTime returnDateTime) {
        super(msgCode, errMsg, receiptDateTime, returnDateTime);
    }

    public CommonResult(int msgCode, String errMsg, ZonedDateTime receiptDateTime, ZonedDateTime returnDateTime, String requesterId, JSONObject item) {
        super(msgCode, errMsg, receiptDateTime, returnDateTime);
        this.item = item;
    }
